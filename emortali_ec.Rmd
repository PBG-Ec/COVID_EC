...
Este análisis busca explorar el exceso de mortalidad como aproximación de medición de la pandemia de COVID 19 en el Ecuador. Se basa en datos de fuentes públicas: defunciones y elementos geográficos. También aporta unos elementos de reflexión sobre les limitaciones para estimar el impacto de la pandemia con este método. Se encuentra en [este](https://github.com/PBG-Ec/COVID_EC) repositorio el código/datos de análisis, usando R & Rmarkdown  (cran-R 4.0.2 y Rstudio 1.3).  
