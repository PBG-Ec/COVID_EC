...
Este análisis busca explorar el exceso de mortalidad como aproximación de medición de la pandemia de COVID 19 en el Ecuador. Se basa en datos de fuentes públicas, de defunciones y elementos geográficos en el Ecuador. También aporta unos elementos de reflexión sobre les limitaciones para estimar el impacto de la pandemia con este método. También se encuentra en [este](https://github.com/PBG-Ec/COVID_EC) repositorio el código de análisis, realizado con R & Rmarkdown  (cran-R 4.0.2 y Rstudio 1.3).  
...
Se podría realizar un ajuste por población proyectada, de las tasas de muertes de periodo de referencia, para obtener comparaciones mas precisas con tasas del periodo 2020...
